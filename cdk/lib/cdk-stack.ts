...
export class CraddockConnectionStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const certificatArn =
      "arn:aws:acm:us-east-1:648035311088:certificate/884a2a78-fc1b-44e3-ad6b-0cc389e5e7fb";
    ...
    const imageBucket = new s3.Bucket(this, "ImageBucket", {
      bucketName: "craddock-connection-images",
      publicReadAccess: false,
      blockPublicAccess: s3.BlockPublicAccess.BLOCK_ALL,
      removalPolicy: cdk.RemovalPolicy.DESTROY,
    });
    ...
    const distribution = new cloudfront.Distribution(
      this,
      "CraddockConnectionDistribution",
      {
        ...
        defaultBehavior: {
          ...
          origin: new cloudfrontOrigins.HttpOrigin(
            siteBucket.bucketWebsiteDomainName,
            {
        ...
        additionalBehaviors: {
          "/images/*": {
            origin: new cloudfrontOrigins.S3Origin(imageBucket),
            viewerProtocolPolicy:
              cloudfront.ViewerProtocolPolicy.REDIRECT_TO_HTTPS,
          },
        },
